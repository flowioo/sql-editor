...
| | |
|:---:|:---:|
| ![Connection dialog](./docs/images/03-connection-dialog.png) | ![AI panel](./docs/images/05-ai-panel.png) |
| Multi-type connection form | Agent integration (planned, see Roadmap) |

### Syntax highlighting

![Syntax highlighting animation](./docs/images/highlight.gif)

> Above: keywords / strings / numbers / identifiers colored token-by-token as you type.
